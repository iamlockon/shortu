...
type DBClient interface {
	...
	UploadURL(c context.Context, url string, expiredAt time.Time, f *filter.Filter) (shorten string, err *errors.Error)
	GetURL(c context.Context, shorten string) (original string, err *errors.Error)
	DeleteURL(c context.Context, shorten string) *errors.Error
